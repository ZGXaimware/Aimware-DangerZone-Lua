...
local aimsmoothstep = gui.Slider(main_box, "main.aimstepsmooth", "平滑自瞄度数", 8, 5, 15, 1)
local aastep        = gui.Slider(main_box, "main.aastep", "平滑AA度数", 8, 5, 15, 1)
