...
local hsmaster = gui.Checkbox(line_box, "vis.hsmaster", "Hostage Snapline", 1)
local ammomaster = gui.Checkbox(line_box, "vis.ammomaster", "Ammobox Snapline", 1)
local boxmaster = gui.Checkbox(line_box, "vis.boxmaster", "NormalBox Snapline", 1)
local cashmaster = gui.Checkbox(line_box, "vis.cashmaster", "Cash Snapline", 1)
local healmaster = gui.Checkbox(line_box, "vis.healmaster", "Healthshot Snapline", 1)
